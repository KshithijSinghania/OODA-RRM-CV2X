...
# ============================================================
# INDORE-02 — HIGH TRAFFIC
# ============================================================

SCENARIO_ID = "INDORE_02"
SCENARIO_NAME = "HIGH_TRAFFIC"
...
SUMO_CONFIG = (
    r"C:\Users\jinda\Sumo\Indore-02"
    r"\osm.sumocfg"
)
...
# Ignore extremely short OSM connector edges.
#
# This prevents artificial values such as:
#
# 5000 veh/km
#
# caused by a vehicle occupying a tiny geometry edge.

MIN_DENSITY_EDGE_LENGTH_M = 20.0


# Density threshold used for identifying
# high-density road segments.
...
def get_edge_geometry(edge_id):
    ...
    Therefore we obtain the length from the
    individual lanes.
    """
...
def get_edge_speed(edge_id):
    ...
    We therefore obtain lane maximum speeds using:
...
print()
print("=" * 75)
print("INDORE-02 — HIGH TRAFFIC TELEMETRY COLLECTION")
print("=" * 75)
...
try:
    ...
    print(
        "Close the CSV files in Excel or "
        "another application and run again."
    )
...
window_edge_density_samples = defaultdict(list)

window_lane_density_samples = defaultdict(list)
...
def write_scenario_window(
    ...
    mean_edge_density = mean(
        edge_density_values
    )

    p95_edge_density = percentile(
        edge_density_values,
        DENSITY_PERCENTILE
    )
    ...
    mean_lane_density = mean(
        lane_density_values
    )

    p95_lane_density = percentile(
        lane_density_values,
        DENSITY_PERCENTILE
    )
...
print()
print("=" * 75)
print("INDORE-02 DATA COLLECTION COMPLETE")
print("=" * 75)
...
print("Density filtering:")
print(
    f"Edges shorter than "
    f"{MIN_DENSITY_EDGE_LENGTH_M} m ignored"
)

print()

print(
    f"P{DENSITY_PERCENTILE} density included"
)
